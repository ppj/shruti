...
class UserSettingsRepositoryTest {
    ...
    @Test
    fun `userSettings flow emits current settings`() =
        runTest {
    ...
    @Test
    fun `updateSaNote persists value correctly`() =
        runTest {
            repository.updateSaNote("D4")
    ...
    @Test
    fun `saFrequency is calculated correctly from saNote`() =
        runTest {
            // Test G#2
    ...
    @Test
    fun `updateTolerance persists value correctly`() =
        runTest {
            repository.updateTolerance(20.0)
    ...
    @Test
    fun `updateTuningSystem persists value correctly`() =
        runTest {
            repository.updateTuningSystem(true)
    ...
    @Test
    fun `updateTanpuraEnabled persists value correctly`() =
        runTest {
    ...
    @Test
    fun `updateTanpuraString1 persists value correctly`() =
        runTest {
    ...
    @Test
    fun `updateTanpuraVolume persists value correctly`() =
        runTest {
    ...
    @Test
    fun `sequential updates to same setting persist latest value`() =
        runTest {
            repository.updateSaNote("C3")
    ...
    @Test
    fun `updateTolerance handles edge case values`() =
        runTest {
    ...
    @Test
    fun `updateTanpuraVolume handles edge case values`() =
        runTest {
            // Test minimum volume
    ...
    @Test
    fun `userSettings flow emits updated values after changes`() =
        runTest {
    ...
    @Test
    fun `updating one setting does not affect other settings`() =
        runTest {
    ...
    @Test
    fun `all tanpura settings can be updated independently`() =
        runTest {
